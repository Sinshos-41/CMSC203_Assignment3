 ...
 * Description: 
 * This class extends BorderPane and lets users encrypt and decrypt text using either the 
 * Caesar cipher or the Bellaso cipher. The layout includes text fields for input and output, radio buttons to choose
 * between ciphers, and buttons to perform encryption, decryption, clearing fields, or exiting the application. 
 * It provides a simple way for users to test encryption methods with GUI.
 * Due: 03/17/2025
